...
export function AboutProject() {
  ...
  return (
    <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden">
      ...
      >
        <h2 className="mb-10 font-serif text-3xl leading-tight tracking-[0.02em] text-ink-strong md:text-[40px]">
          关于企划
        </h2>
        ...
        <div className="space-y-6 font-sans text-base leading-[1.8] text-ink md:text-lg">
          ...
          <p>
            企划发起自海大 Gal 同好群“海带姬松书院”。我们试图打破次元的边界，将那些原本只存在于游戏屏幕中的少女，
            带入触手可及的真实校园。
          </p>
          <p>
            这里的每一处选址、每一位登场人物，乃至画面背后承载的那段微小故事，均脱胎于群友的提案与共创。
